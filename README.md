...
- **Modular Components**: Reusable UI elements for Navbar, Footer, and more.
...
- Start editing the page by modifying `src/app/page.tsx`. The page auto-updates as you edit the file.
...
4. Deploy the site: `firebase deploy --only hosting`
